...
```{r}
world=map_data("world")
HappyMap=left_join(HappyPlanetIndex,world,by=c('Country'='region'))
...
#USA and a couple other countries blank because of different names in world vs. HPI (USA vs. United States of America, for example). Tried to copy the code from the link to rename it, but end up getting a map of *only* the US.
```
